...
| Optional server-ledger operations smoke | in-repo optional ledger operations | 2026-05-13 | [`release-0.18.0-adoption-readiness.md`](../audits/release-0.18.0-adoption-readiness.md), [`2026-05-13-external-trust-closeout.md`](../handoffs/2026-05-13-external-trust-closeout.md) | In-repo proof covers optional decision upload/history/latest/debt/export, dry-run prune preservation, audit visibility, and API key create/list/rotate smoke. | External team operation, backup/restore drills, production retention, large histories, migration compatibility, or any requirement that server mode be part of local correctness. | `recent` |
