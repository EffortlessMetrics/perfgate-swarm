...
Created: 2026-05-19
Milestone: 0.21.0
Current PR: status/evidence-intake-claims
...
| TBD | Product claims and canary freshness | in progress | `docs/status/PRODUCT_CLAIMS.md`, `docs/status/CANARY_MATRIX.md` |
