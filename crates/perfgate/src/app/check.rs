...
use perfgate_types::{
    ...
    MetricStatistic, PerfgateError, PerfgateReport, RunReceipt, ScalingConfig, ToolInfo,
...
use self::reporting::{
    build_no_baseline_report, build_report, detect_high_cv, render_no_baseline_markdown,
};
...
mod tests {
    ...
    use perfgate_types::{
        ...
        CompareReceipt, DefaultsConfig, Delta, Direction, HostInfo, Metric, MetricStatus,
        REPORT_SCHEMA_V1, RunMeta, Sample, ScalingConfig, Severity, Stats, U64Summary, Verdict,
        VerdictCounts,
    };
