...
//!
//! ```
//! use perfgate_domain::{compute_paired_stats, compare_paired_stats, PairedError};
...
use crate::stats::{summarize_f64, summarize_u64};
use perfgate_types::{
...
///
/// ```
/// use perfgate_domain::{compare_paired_stats, PairedComparison};
...
///
/// ```
/// use perfgate_domain::compare_paired_stats;
/// use perfgate_types::{PairedStats, PairedDiffSummary, U64Summary};
///
/// let stats = PairedStats {
